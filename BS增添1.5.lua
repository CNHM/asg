...
local Window = OrionLib:MakeWindow({Name ="BS脚本(增添)1.4", HidePremium = false, SaveConfig = true,IntroText = "BS中心(增添)1.4开启", ConfigFolder = "BS中心(增添)1.4"})
