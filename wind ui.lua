...
if not H then
warn("[ WindUI.创造 ]  '"..identifyexecutor().."' 不支持URL图像 错误: "..J)
...
if not aC then
warn("[ WindUI.背景 ]  下载视频失败: "..tostring(aD))
return
end
end
...
local x=ah("搜索","search",an.UIElements.SideBarContainer)
